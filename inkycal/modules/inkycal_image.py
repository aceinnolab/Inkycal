...
class Inkyimage(inkycal_module):
    ...
    def __validate(self):
        ...
        if not isinstance(self.image_path, str):
            print('image_path has to be a string: "URL1" or "/home/pi/Desktop/im.png"')

        # Validate layout
        if not isinstance(self.layout, str) or (self.layout not in self._allowed_layout):
        ...
        # Validate colours
        if not isinstance(self.colours, str) or (self.colours not in self._allowed_colours):
    ...
    def generate_image(self) -> None:
        ...
        self.__remove_alpha()
        self.__to_layout()
        black, colour = self.__map_colours()
    ...
    def __rotate(self, angle: Union[int, str] = None):
        """
    ...
    def __fit_width(self, width: Union[int, float] = None) -> None:
        """
    ...
    def __fit_height(self, height: Union[int, str] = None) -> None:
        """
    ...
    def __to_layout(self, mode: str = None) -> None:
        """
    ...
    def __map_colours(self, colours: str = None) -> tuple:
        """
    ...
    @staticmethod
    def __show(image) -> None:
        """
        Preview the image on gpicview (only works on Rapsbian with Desktop)
        """
        _path = '/home/pi/Desktop/'
        image.save(_path + 'temp.png')
        os.system("gpicview " + _path + 'temp.png')
        os.system('rm ' + _path + 'temp.png')
